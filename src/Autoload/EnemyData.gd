...
var simulation_score: = 0 setget set_simulation_score
...
func set_simulation_score(value: int) ->void:
	simulation_score = value
## =============
...
var src = [] setget set_src
signal myturnasatile
var whowhere = [] setget set_whowhere
var fancymap = [] setget set_fancymap
var decision = -1 setget set_decision
...
func set_direction(value):
	direction = value
	pass
func set_fancymap(value: Array) -> void:
	fancymap = value
func set_decision(value: int) -> void:
	decision = value
	emit_signal("ia_played", decision)
## ##
